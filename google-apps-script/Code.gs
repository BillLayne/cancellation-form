...
function sendCustomerEmail_(p, confirmNum) {
  ...
  var html = [
    ...
    '<p style="margin:0 0 12px;font-family:Arial,sans-serif;font-size:13px;color:#94a3b8;"><a href="tel:3368351993" style="color:#60a5fa;text-decoration:none;">' + CONFIG.AGENCY_PHONE + '</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="mailto:docs@billlayneinsurance.com" style="color:#60a5fa;text-decoration:none;">docs@billlayneinsurance.com</a></p>',
    '</td></tr>',
